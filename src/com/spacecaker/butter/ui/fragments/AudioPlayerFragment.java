...
package com.spacecaker.butter.ui.fragments;

import static com.spacecaker.butter.Constants.ALBUM_ID_KEY;
...
import com.spacecaker.butter.activities.TracksBrowser;
...
import com.spacecaker.butter.ui.widgets.RepeatingImageButton;
import com.spacecaker.butter.ui.widgets.VisualizerView;
        ...
        try {
            switch (MusicUtils.mService.getRepeatMode()) {
                case ApolloService.REPEAT_ALL:
                    mRepeat.setImageResource(R.drawable.butter_holo_light_repeat_all);
                    break;
                case ApolloService.REPEAT_CURRENT:
                    mRepeat.setImageResource(R.drawable.butter_holo_light_repeat_one);
                    break;
                default:
                    mRepeat.setImageResource(R.drawable.butter_holo_light_repeat_normal);
                    // Theme chooser
