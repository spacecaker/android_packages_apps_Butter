...
package com.spacecaker.butter.app.widgets;
 ...
 * next track buttons.
 */
public class AppWidget422 extends AppWidgetProvider {

    public static final String CMDAPPWIDGETUPDATE = "appwidgetupdate4x22";

    private static AppWidget422 sInstance;

    public static synchronized AppWidget422 getInstance() {
        if (sInstance == null) {
            sInstance = new AppWidget422();
        }
        return sInstance;
    }
    ...
    private void defaultAppWidget(Context context, int[] appWidgetIds) {
    	...
    	final RemoteViews views = new RemoteViews(context.getPackageName(),
                (widget_type.equals(context.getResources().getString(R.string.widget_style_light))?R.layout.fourbytwo_app_sleek_widget:R.layout.fourbytwo_app_sleek_widget_dark));
    ...
    public void performUpdate(ApolloService service, int[] appWidgetIds) {
    	...
    	final RemoteViews views = new RemoteViews(mContext.getPackageName(),
                (widget_type.equals(mContext.getResources().getString(R.string.widget_style_light))?R.layout.fourbytwo_app_sleek_widget:R.layout.fourbytwo_app_sleek_widget_dark));
