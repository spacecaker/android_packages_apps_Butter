...
public class ApolloService extends Service {
    ...
    public static final String APOLLO_PACKAGE_NAME = "com.spacecaker.butter";

    public static final String MUSIC_PACKAGE_NAME = "com.android.music";

    public static final String PLAYSTATE_CHANGED = "com.spacecaker.butter.playstatechanged";

    public static final String META_CHANGED = "com.spacecaker.butter.metachanged";

    public static final String FAVORITE_CHANGED = "com.spacecaker.butter.favoritechanged";

    public static final String QUEUE_CHANGED = "com.spacecaker.butter.queuechanged";

    public static final String REPEATMODE_CHANGED = "com.spacecaker.butter.repeatmodechanged";

    public static final String SHUFFLEMODE_CHANGED = "com.spacecaker.butter.shufflemodechanged";

    public static final String PROGRESSBAR_CHANGED = "com.spacecaker.butter.progressbarchnaged";

    public static final String REFRESH_PROGRESSBAR = "com.spacecaker.butter.refreshprogessbar";

    public static final String CYCLEREPEAT_ACTION = "com.spacecaker.butter.musicservicecommand.cyclerepeat";

    public static final String TOGGLESHUFFLE_ACTION = "com.spacecaker.butter.musicservicecommand.toggleshuffle";

    public static final String SERVICECMD = "com.spacecaker.butter.musicservicecommand";
    ...
    public static final String TOGGLEPAUSE_ACTION = "com.spacecaker.butter.musicservicecommand.togglepause";

    public static final String PAUSE_ACTION = "com.spacecaker.butter.musicservicecommand.pause";

    public static final String PREVIOUS_ACTION = "com.spacecaker.butter.musicservicecommand.previous";

    public static final String NEXT_ACTION = "com.spacecaker.butter.musicservicecommand.next";
